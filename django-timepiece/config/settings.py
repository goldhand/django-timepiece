# -*- coding: utf-8 -*-
"""
Django settings for django-timepiece project.
...
class Common(Configuration):
    ...
    DATABASES = values.DatabaseURLValue('postgres://localhost/django-timepiece')
    ...
    #COMPRESS_ROOT = '%s/static/' % os.path.dirname(BASE_DIR)
    COMPRESS_ROOT = join(os.path.dirname(BASE_DIR), 'static')
...
class Production(Common):
    ...
    DEFAULT_FROM_EMAIL = values.Value(
            'django-timepiece <django-timepiece-noreply@djangonu-timepiece.herokuapp.com>')
    EMAIL_HOST = values.Value('smtp.sendgrid.com')
    EMAIL_HOST_PASSWORD = values.SecretValue(environ_prefix="", environ_name="SENDGRID_PASSWORD")
    EMAIL_HOST_USER = values.SecretValue(environ_prefix="", environ_name="SENDGRID_USERNAME")
    EMAIL_PORT = values.IntegerValue(587, environ_prefix="", environ_name="EMAIL_PORT")
    EMAIL_SUBJECT_PREFIX = values.Value('[django-timepiece] ', environ_name="EMAIL_SUBJECT_PREFIX")
    EMAIL_USE_TLS = True
